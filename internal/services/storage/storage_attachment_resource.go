...
func (s *storageAttachmentResource) GetStorageSnapshotByIdentifier(ctx context.Context, identifier string) (goEldelta.StorageSnapShot, error) {
	...
	return goEldelta.StorageSnapShot{}, fmt.Errorf("snapshot not found")
}
